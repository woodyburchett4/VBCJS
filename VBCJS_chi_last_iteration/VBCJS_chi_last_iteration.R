# Run VB Model using the original approach, then run the chi-likelihood appraoch for one iteration at the end of the algorithm
...
VBCJS <- function(X, Y, f, l, priors, inits, converge.criterion=1e-5){
  ...
  VB.time <- system.time({
    ...
    # Run more accurate Laplace approximation for beta and eta
